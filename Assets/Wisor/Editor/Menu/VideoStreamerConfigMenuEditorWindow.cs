...
public class VideoStreamerConfigMenuEditorWindow : EditorWindow
{
    private VideoStreamerConfig config;

    public static void Init(VideoStreamerConfig targetConfig)
    {
        VideoStreamerConfigMenuEditorWindow window = GetWindow<VideoStreamerConfigMenuEditorWindow>("Video Streamer Config");
