...
public class VideoReceiverConfigMenuEditorWindow : EditorWindow
{
    private VideoReceiverConfig config;

    public static void Init(VideoReceiverConfig targetConfig)
    {
        VideoReceiverConfigMenuEditorWindow window = GetWindow<VideoReceiverConfigMenuEditorWindow>("Video Receiver Config");
